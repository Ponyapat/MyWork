<template>
  <div id="demo5">
      ...
      <div :class="[false ? error : ' ' , important]">Silly Fools</div>
      <div :style="{color,fontSize}">Binding Style</div>
      <div :style="isActive ?  styleObj : ' ' ">Binding Style Object</div>
